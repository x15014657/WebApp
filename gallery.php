	...
	<body>
		<div class="container-fluid">
			<div class="row padding">
				...
				<div class="col-md-2"><img src="img/logo-bird.png" alt="logo-renovation"/></div>
				<div class="col-md-offset-1"></div>
				<div class="col-md-4"></div>
			</div>
		</div>
			...
			<div class="contaianer-fluid">
				...
				<div class="collapse navbar-collapse" id="mainNavBar">
					<ul class="nav nav-tabs nav-justified">
						...
						<li class="active"><a href="gallery.php">Collections</a></li> 
		...
		<div class="container">
			<div class="row padding">
				<div class="col-md-12">
					<div class="well">
						<div class="gallery1">
							<h1 class="text-centre"> Music Collections</h1> <hr>
