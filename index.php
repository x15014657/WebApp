		...
		<div class="container">
			<div class="row padding">
				...
				<div class="col-md-4">
					<div class="well">
						<div class="welcome">
							<h1 class="text-centre" id="fade"> Welcome</h1> <hr>
							<h2> <em>Music-<span>Zone</span> </em> </h2><p class="text-justified">  is a locally owend and operated business
								that sales <span>music CD </span>as well as <span>handyman</span> services in Dublin and surroundings.</p>
